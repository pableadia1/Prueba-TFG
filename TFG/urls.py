...
from Estadisticas.views import maxGoleadoresAsistentes,maxGoleadoresAsistentesEquipo, estadisticasJugador, estadisticasPrueba
...
urlpatterns = [
    ...
    path('jugador/maximos', maxGoleadoresAsistentes.as_view(), name="Maximos"),
