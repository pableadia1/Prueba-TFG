...
class Equipo(models.Model):
    ...
    partidosJugados = models.IntegerField( null=True)
    victorias = models.IntegerField(null=True)
    derrotas = models.IntegerField(null=True)
    empates = models.IntegerField(null=True)
    golesFavor = models.IntegerField(null=True)
    golesContra = models.IntegerField(null=True)
